...
class Student:
    def __init__(self,root):
        ...
        dep_combo["values"]=("Select Department","CSE","AIML","AIDS","IT","ECE","EEE","CIVIL","MECH")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","OS","DAA","DS","CN","COA","TOC","CD","DBMS")
        ...
        sem_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",12,"bold"),width=20,state="read only")
        ...
        take_photo_sample_btn=Button(btn1_frame,text="Take Photo Sample",command=self.generate_dataset,font=("times new roman",12,"bold"),bg="blue",fg="white",width=39)
        take_photo_sample_btn.grid(row=0,column=0)
        update_photo_sample_btn=Button(btn1_frame,text="Update Photo Sample",font=("times new roman",12,"bold"),bg="blue",fg="white",width=40)
        ...
        f1_lbl=Label(right_frame,image=self.photoimg_right)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="1234",database="face_recogonizer")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Genterating data sets completed successfully")
